/*  Module 5: Declare and instantiate classes in TypeScript
    ...
    interface BuildArrayInterface {
        items: number,
        sortOrder: Sort,
        buildArray(): Array<number>,
    }

/*  EXERCISE 1 */

class BuildArray implements BuildArrayInterface {
    // TODO Define the properties
    private _items: number;
    private _sortOrder: Sort;
    // TODO Define the constructor
    constructor(items: number, sortOrder: Sort) {
        this._items = items;
    ...
    // Build Array
    public buildArray(): Array<number> {
...
testArray2.sortOrder = 'ascending';
